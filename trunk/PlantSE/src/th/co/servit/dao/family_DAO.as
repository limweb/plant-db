package th.co.servit.dao
{
	...
	*/
	...
	public class family_DAO
	{
		...
		private static var instance:family_DAO;
		public static function getInstance():family_DAO {
			if( instance == null )
				instance = new family_DAO( new SingletonLock );
			return instance;
		}
		
	
		public function family_DAO( lock: SingletonLock) {
		}
